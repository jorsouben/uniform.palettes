...
A primeira conclusión rotunda é que a paleta --ou mapa de cores-- empregada na visualización de datos debe considerarse unha entidade separada dos elementos de imaxe corporativa, de marca, estéticos... Así e todo, pode buscarse unha harmonía entre ambas seleccións de cores.

A segunda e máis importante: As mapas de cores aplicadas aos datos deben ser **científicas**.

## Mapas de cores científicos

A presentación de datos científicos debe facerse sen introducir características artificiais ou eliminar detalles reais, ademáis de ser universalmente accesible. Non debe distorsionar os datos e ten que transmitir verazmente a realidade destes.
...
Os anteriores principios materialízanse na colección de *Scientific Colour Maps* de Fabio Crameri, da que falaremos despois.
...
As distancias entre puntos de datos e as distancias entre cores correspondentes deben seguir unha proporción constante.
...
Tampouco contan con métodos para replicar as análises de Fabio Crameri nin facer algunhas das representacións visuais desexadas.
...
Estas dúas paletas son a encarnación de todo o que non debe ser unha paleta axeitada para a representación científica de datos:
...
O espazo de cor HCL (Hue, Chroma, Luminance) é un modelo deseñado para ser perceptualmente uniforme, que representa as cores segundo tres atributos relacionados ca percepción humana:
...
Estas paletas son boas opcións, pero non seguen exactamente os criterios dos "Scientific Colour Maps".
...
Á luz dos anteriores exemplos, falemos da orde perceptual.

Unha paleta adecuada transmite a orde dos valores de xeito intuitivo, sen necesidade de consultar unha lenda. 

Esta orde perceptual ven determinada polo percorrido da paleta no espazo de cor e, especialmente, pola luminancia, que debe ser monótona e idealmente de pendente constante.
