...
O espazo de cor HCL (Hue, Chroma, Luminance) é un modelo perceptualmente uniforme que representa as cores segundo tres atributos que se corresponden coa percepción humana:
...
Este modelo é especialmente útil en visualización de datos porque permite crear paletas de cores que manteñen a uniformidade perceptiva, evitando distorsións visuais que aparecen en modelos como RGB ou HSV

## Espazos de cor: HCL. O paquete `colorspace`

O paquete `colorspace` enfócase na análise de mapas de cores no espazo HCL. Ofrece varias ferramentas que incorporo no meu fluxo de traballo así como unha colección de paletas uniformes **no espazo HCL**.
